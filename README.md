...
- [apache/airflow #66597](https://github.com/apache/airflow/pull/66597) — Clarified `HttpOperator` `response_filter` and XCom usage in the documentation and system test example.
- Improved the example to match the actual `httpbin /get` response structure.
- Merged into `apache/airflow:main`.
